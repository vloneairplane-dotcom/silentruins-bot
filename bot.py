...
MOODS = {
    "rain": {
        ...
        "captions": [
            "باران که می‌گیرد، بعضی خاطره‌ها هم بی‌اجازه برمی‌گردند.",
            "صدای باران برای بعضی‌ها آرامش است؛ برای بعضی‌ها یادآوری.",
            "پشت پنجره، شهر خیس می‌شود و فکرهای قدیمی بیدار.",
            "بعضی شب‌ها فقط باران می‌داند چرا هنوز بیداری.",
            "باران می‌بارد؛ انگار آسمان هم چیزی برای گفتن دارد.",
            "گاهی دلت فقط یک پنجره می‌خواهد و صدای باران.",
            "هر قطره‌ی باران، یک خاطره‌ی دور را نزدیک می‌کند.",
            "باران که می‌زند، سکوت خانه عمیق‌تر می‌شود.",
        ],
    },
    "night": {
        "fa": "شب",
        ...
        "captions": [
            "شب که می‌شود، فکرهایی برمی‌گردند که روز فرصت شنیدنشان نیست.",
            "نیمه‌شب، سکوت بلندتر از هر حرفی شنیده می‌شود.",
            "یک سقف، یک آهنگ، و فکرهایی که تمام نمی‌شوند.",
            "بعضی جواب‌ها فقط در تاریکی پیدا می‌شوند.",
            "شب همیشه چیزی را یاد آدم می‌اندازد که فراموشش کرده بود.",
            "چراغ‌های شهر روشن‌اند؛ بعضی پنجره‌ها هنوز منتظرند.",
            "ماه بالاست و بعضی دلتنگی‌ها پایین نمی‌آیند.",
            "گاهی خواب نمی‌بری؛ فقط منتظری فکرها خسته شوند.",
        ],
    },
    "lonely": {
        "fa": "تنهایی",
        ...
        "captions": [
            "تنهایی وقتی سخت می‌شود که میان آدم‌ها هم احساسش کنی.",
            "بعضی سکوت‌ها از هزار حرف بیشتر خستگی را نشان می‌دهند.",
            "آدم می‌تواند میان شلوغی باشد و باز هم تنها بماند.",
            "گاهی هیچ‌کس کم نیست؛ فقط یک نفر زیادی مهم است.",
            "تنهایی یعنی حرفی داشته باشی و نخواهی به هیچ‌کس بگویی.",
            "بعضی آدم‌ها می‌روند و جای خالی‌شان می‌ماند.",
            "وقتی عادت می‌کنی خودت خودت را آرام کنی، سکوت عادی می‌شود.",
            "همه‌چیز سر جایش است؛ جز کسی که باید اینجا می‌بود.",
        ],
    },
    "love": {
        "fa": "دلتنگی",
        ...
        "captions": [
            "دلتنگی یعنی هنوز چیزی تمام نشده، حتی اگر رابطه تمام شده باشد.",
            "بعضی آدم‌ها می‌روند؛ خاطره‌شان اما بلد نیست برود.",
            "فاصله همیشه کیلومتر نیست؛ گاهی یک تصمیم است.",
            "بدترین بخش رفتن، ادامه دادنِ روزهای بعد از آن است.",
            "هنوز بعضی آهنگ‌ها تو را به همان روز برمی‌گردانند.",
            "دلتنگی آرام نمی‌آید؛ وسط ساده‌ترین لحظه‌ها پیدایش می‌شود.",
            "گاهی دلت برای آدمی تنگ می‌شود که دیگر نمی‌توانی به او برگردی.",
            "آخر بعضی قصه‌ها فراموشی نیست؛ فقط عادت کردن به نبودن است.",
        ],
    },
    "tired": {
        "fa": "خستگی",
        ...
        "captions": [
            "خستگیِ دل با خواب خوب نمی‌شود؛ با فهمیده شدن چرا.",
            "بعضی روزها فقط دوام آوردن، تمام توان آدم را می‌گیرد.",
            "حرف‌های نگفته گاهی از خودِ خستگی سنگین‌ترند.",
            "گاهی چیزی نمی‌خواهی؛ فقط می‌خواهی چند ساعت هیچ‌چیز نباشد.",
            "وقتی از توضیح دادن خسته می‌شوی، سکوت انتخاب ساده‌تری است.",
            "بعضی آدم‌ها آرام‌اند؛ نه چون خوب‌اند، چون دیگر توان جنگیدن ندارند.",
            "فکر زیاد، حتی یک شب آرام را هم طولانی می‌کند.",
            "گاهی باید از همه‌چیز فاصله گرفت تا دوباره صدای خودت را بشنوی.",
        ],
    },
    "ruins": {
        "fa": "ویرونه",
        ...
        "captions": [
            "هر ویرانه‌ای یک روز خانه‌ی کسی بوده است.",
            "بعضی چیزها خراب نمی‌شوند؛ فقط کم‌کم خاموش می‌شوند.",
            "در بعضی خرابه‌ها، خاطره هنوز از دیوارها محکم‌تر است.",
            "مه که می‌آید، مرز بین گذشته و امروز محو می‌شود.",
            "جایی که چراغی نمانده، خاطره‌ها هنوز روشن‌اند.",
            "بعضی پایان‌ها شبیه خانه‌ای متروک‌اند؛ هنوز ردِ زندگی در آن‌ها هست.",
            "زمان از کنار ویرانه‌ها می‌گذرد، اما همه‌چیز را با خودش نمی‌برد.",
            "گاهی آدم هم شبیه یک خانه‌ی قدیمی می‌شود؛ ساکت، خالی، پر از خاطره.",
        ],
    },
}
